...
public class Question_08 {
    public static void main(String[] args) {
        ...
        // GMT * 60 will give the exact number of minutes
        // GMT - (int) GMT gives the exact number of the minutes after the complete hour
        ...
        System.out.println("Current time is (HH:MM:SS) " + hours + ":" + minutes + ":" + seconds);
